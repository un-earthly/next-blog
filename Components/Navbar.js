...
export default function Navbar({ children }) {
    ...
    return (
        <div data-theme={theme ? 'cupcake' : "night"} className="drawer font-poppins">
            ...
            <div className="drawer-side">
                ...
                <ul className="menu items-start p-4 overflow-y-auto w-80 bg-base-100 space-y-3 lg:space-y-0">
                    <label htmlFor="my-drawer-3" className="absolute top-4 right-3 z-50"><i className="bi bi-x-circle text-3xl active:text-error"></i></label>
                    {menuLinks}
                </ul>
